...
public class RedisHelper extends RedisProvider{
	...
	public static Object getObject(String key, String field) {
		...
		return SerializeUtil.unserialize(rtn);//ObjectsTranscoder.getObjectsTranscoder().deserialize(rtn);
	}
	...
	public static void addObject(String key, Object obj) {
		...
		try {
			jedis = getJedis();
			jedis.sadd(key.getBytes(), SerializeUtil.serialize(obj));
